...
if test_mp3 is not None:
    # Dynamically save the file to a temporary location or read it directly
    filepath = test_mp3.name  # Save the uploaded file's name
    with open(filepath, "wb") as f:  # Write the file to the same directory or a dynamic path
        f.write(test_mp3.getbuffer())
    
    st.success(f"File uploaded and saved as {filepath}")     
